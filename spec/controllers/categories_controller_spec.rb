...
describe CategoriesController do
  ...
  describe 'GET #show' do
    ...
    #     binding.pry
        # expect(assigns(:items)).to match(Item.where(category_id: [2, 21, 43, 56, 62, 67, 78, 87, 95, 114,
        #  201, 214, 238, 248, 257, 270, 276, 284, 293, 323,
        #  681, 692, 698, 707, 722, 731, 747, 754, 758, 769, 
        #  894, 900, 909, 918, 926, 935, 944, 951, 965, 977, 
        #  1089, 1099, 1106, 1111, 1119, 1123, 1129, 1134, 1137, 1090]).sort{|a, b| b.id <=> a.id}.values_at(0..5))
    #   else
        # expect(assigns(:items)).to match(Item.where(category_id: [2, 21, 43, 56, 62, 67, 78, 87, 95, 114, 
        #  201, 214, 238, 248, 257, 270, 276, 284, 293, 323, 
        #  681, 692, 698, 707, 722, 731, 747, 754, 758, 769, 
